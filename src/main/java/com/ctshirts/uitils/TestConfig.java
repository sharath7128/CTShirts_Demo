package com.ctshirts.uitils;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "sharath818@gmail.com";
	public static String password = "Indian@321";
	public static String[] to ={"sharath7128@gmail.com","sharath7128@gmail.com"};
